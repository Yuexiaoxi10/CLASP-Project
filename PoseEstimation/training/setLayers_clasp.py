...
caffe_path = '/home/yuexi/Documents/Realtime_Multi-Person_Pose_Estimation/caffe_train/'
import sys, os
...
GPU_ID = 3 # Switch between 0 and 1 depending on the GPU you want to use.
caffe.set_mode_gpu()
...
def setLayers_twoBranches(data_source, batch_size, layername, kernel, stride, outCH, label_name, transform_param_in, deploy=False, batchnorm=0, lr_mult_distro=[1,1,1]):
    ...
    if deploy == False and "lmdb_5A_9A" not in data_source:
        if(len(label_name)==1):
...
%sbuild/tools/caffe train --solver=pose_solver.prototxt --gpu=$3 \
--weights=/home/yuexi/Documents/Realtime_Multi-Person_Pose_Estimation/training/Clasp_exp_caffe/model_5A_9A/pose_iter_300000.caffemodel \
2>&1 | tee ./output.txt' % caffe_path)


#--weights=/home/yuexi/Documents/Realtime_Multi-Person_Pose_Estimation/model/_trained_COCO/pose_iter_440000.caffemodel
if __name__ == "__main__":
    ...
    if(exp == 1):
        directory = 'Clasp_exp_caffe/'
        serverFolder = '/home/yuexi/Documents/Realtime_Multi-Person_Pose_Estimation/training/CLASP/Clasp'
        base_folder = '/home/yuexi/Documents/Realtime_Multi-Person_Pose_Estimation/training/'+directory+'model'
        dataFolder = '/home/yuexi/Documents/Realtime_Multi-Person_Pose_Estimation/training/CLASP/Clasp/lmdb_5A_9A_exp4/'
        source = '/home/yuexi/Documents/Realtime_Multi-Person_Pose_Estimation/training/CLASP/Clasp/lmdb_5A_9A_exp4/'
        base_lr = 8e-6   # 2e-5
        batch_size = 5
        #np = 56    # num_parts
        np = 56
